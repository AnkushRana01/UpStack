import { Download, File, Folder, Share2, Trash2, FileText, Image as ImageIcon, Video, Music, Loader2 } from 'lucide-react';
  ...
  if (!files.length) {
    return (
      <div className="rounded-2xl border border-slate-100 bg-white p-16 text-center text-slate-500 dark:border-slate-800 dark:bg-slate-900/60 dark:text-slate-400">
        ...
        <p className="text-xs text-slate-400 mt-1">Use the upload button above to add files.</p>
      </div>
    );
  }
